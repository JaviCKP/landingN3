      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="hidden md:grid grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 md:col-span-7 flex flex-col space-y-6 text-left">
            ...
            {/* Top spacer or layout balance (badge removed as requested) */}
            <div className="pt-2" />
            ...
            >
              No leas esto si no quieres <br className="hidden lg:inline" />
              <span className="text-cyan-bright relative inline-block border-b-2 border-cyan-bright pb-1 mr-2">
                distinguirte
              </span>
            ...
            {/* Checklist section removed as requested */}
        ...
        <div className="flex md:hidden flex-col items-center text-center space-y-6 pt-4">
          
          {/* Action indicator spacer */}
          ...
          <h1 className="text-3xl font-display font-medium text-white leading-tight px-1 max-w-[400px]">
            No leas esto si no quieres <span className="text-cyan-bright border-b border-cyan-bright/40 pb-0.5">distinguirte</span> de otras inmobiliarias.
          </h1>
          ...
          <p className="text-base text-slate-300 leading-relaxed max-w-[340px] px-2 font-normal">
            El mercado no tiene horarios. Mientras tu agencia descansa, otra que responde al instante se queda con la visita. Delega la atención nocturna a nuestro asistente.
          </p>
